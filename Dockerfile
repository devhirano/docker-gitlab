FROM ubuntu:14.04
MAINTAINER hirano <devhirano@gmail.com>

ENV TERM xterm

# INSTALL Base Packages
RUN apt-get update && \
    apt-get -y install ssh git vim man lsof curl && \
    apt-get -y install python-setuptools python python-pip python-dev libxml2-dev libxslt-dev 
